...
void LuaState::setState(lua_State *state, LuaAPI *api, bool bindAPI) {
	...
	createQuaternionMetatable(); // "mt_Quaternion"
	createBasisMetatable(); // "mt_Basis"
	createTransform2DMetatable(); // "mt_Transform2D"
	createTransform3DMetatable(); // "mt_Transform3D"
	createProjectionMetatable(); // "mt_Projection"
	createAABBMetatable(); // "mt_AABB"
